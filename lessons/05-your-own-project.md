# Lesson 05 — Build Your Own Project
...
| --- | --- | --- |
| **About Me page** | Shows your name, a photo, and things you like | Simple and personal — mostly HTML and CSS |
| **To-Do list** | You type a task, click a button, and it appears in a list | Teaches buttons and lists |
| **Dice roller** | You click a button and get a random number from 1 to 6 | Fun, and teaches how "random" works |
| **Compliment generator** | You click a button and get a kind message | Makes people smile — very rewarding |

There's no wrong pick. Choose the one that makes *you* curious.

---

## Step 2 — Make a home for your project
...
[your-project-name], and put an empty index.html file inside it. Then
show me the file so I can start. Explain what you did in one or two
sentences.
```

See the new folder inside `my-projects/`? That's your project's home. There's a short note about this folder in [my-projects/README.md](../my-projects/README.md) if you want to peek.
...
want a button that says "Roll". When I click it, show a random number
from 1 to 6 in big text on the page. Let's build it ONE small piece at
a time, and explain each piece. Start with just the button, nothing
else yet.
```

Notice the magic words: **"one small piece at a time."** That's the secret. Don't ask for the whole thing at once. Build the button. Get it working. *Then* make it show a number. *Then* make it look nice. One brick at a time builds a strong wall.

---

## Step 4 — Build, test, tweak — again and again
...
```text
Here is my file: [paste it]. It's not doing what I expected. I wanted
[what you wanted], but I got [what happened] instead. What's wrong, and
how do I fix it? Keep it simple.
```
...
I like [your favorite colors / style]. Suggest small changes and
explain them one at a time.
```

This is *your* project. There's no rule for how it should look. If you like it, it's right.
...
Right now your project only lives on your computer. What if it disappeared? Next you'll learn to **save your work safely** so it can never be lost — using a tool called Git.

Go to **[lessons/06-saving-work-with-git.md](06-saving-work-with-git.md)**.
