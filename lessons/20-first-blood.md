...
- [ ] **Ledger:** your **live URL** and the real-stranger evidence (distinct accounts, timestamps that match an outside clock like your deploy/analytics log) are in `forge/PROOF.md` — links your instructor can open, not screenshots.
- [ ] **Live gate (with your instructor, not just MILO):** before the call, drill with MILO. On the call, your instructor reads your actual repo and names a target only findable there — *"the header color is one variable in one file: change it to red, and tell me the file and line before you push"*, or *"find the function that saves a user and make the live form reject a blank email."* You say what you'll change and why *first*, then do it while they watch your public URL actually change. The proof is them seeing it change — not a screenshot.
- [ ] **Reachable strangers (your instructor samples them):** at least **2 of your 5** left a trace on a public third-party surface your instructor can open (a real reply, a review/star with a profile that predates your launch, a public post) — self-notified signup emails and bare anonymous clicks don't count. For at least 1, **your instructor** messages that stranger at a time you can't predict and asks: *"How did you find this, and did anyone ask or pay you to try it?"* "A friend sent me / the maker asked me / it was paid" **fails that entry** — first blood means they *found* you.
