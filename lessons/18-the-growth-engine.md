...
- [ ] **Prove it's really yours:** you can defend this work to MILO out loud — *why you called Round 1 the way you did, which AI outputs you killed and why, what the humans actually did* — in your own words, with the files open. If you can't explain a decision, you didn't really make it. (Ask: `"Mentor, quiz me on my growth engine — assume I leaned on AI too hard, and find out."`) This drill also gets you *ready* for Level 4's real entry gate — a live call with your instructor on this Level-3 work (see [Lesson 19](19-the-forge-lights.md)). Passing it with MILO is rehearsal; only your instructor opens the door.
