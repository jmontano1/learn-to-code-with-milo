...
Before you type, let me hand you three words. You'll use them a lot, so let's make them friendly.
...
Open Claude Code and make sure you're working inside `my-projects/`. If you're not sure, just ask Claude. Paste this:
...
## Step 2: Ask Claude to guide you line by line
...
So instead of asking Claude to *write* the file, you'll ask Claude to *coach* you while you write it.
...
Then follow along. Type each line as Claude tells you. Put your **real name** where the blank is.
...
Ask Claude how to do it. Paste this:
...
Do what Claude says. In a moment, your own words will appear on the screen.
...
3. Add a second `<p>` paragraph with anything you want. Not sure how? Ask Claude: `How do I add a second paragraph to my page?`
...
If you can't get it back to normal, don't panic. Ask Claude:
...
> By the way: this same "type it, see it, change it, break it, fix it" muscle is exactly what you'll use later when you help test the real GetAdvice app and give it feedback (see `feedback-getadvice/README.md`). You're already training for it.
