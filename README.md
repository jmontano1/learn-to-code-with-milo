...
**How Level 4 is checked (and why).** The Forge is checked by real proof and a real person, not by trusting a claim. You keep a Proof Ledger of links a stranger could verify, and you defend your work to Tío on a short live call where he'll ask you to explain and *change your own code on the spot*. Here's the important part, said plainly: **using AI to *learn* — to explain things, to coach you, to help you write code you understand and can change — is the whole point, and it's encouraged.** The only line is work you can't defend as your own. AI that *coached* you is a superpower; AI that *did it for you* leaves you with nothing to show and nothing to defend. What the mentor does is written in [`my-projects/forge/PROCTOR.md`](my-projects/forge/PROCTOR.md) and [`my-projects/forge/SHOW-ME.md`](my-projects/forge/SHOW-ME.md).
